(function () {
    ...
    .directive('searchCar', function () {
        var controller = ['$scope', '$log', function ($scope, $log) {
            $scope.leftMargin = -50;
            $scope.pickupDate = "picking up date";
            $scope.pickupTime = "Time";
            $scope.dropOffDate = "dropping off date";
            $scope.dropOffTime = "Time";
        ...
        return {
            restrict: 'E',
            templateUrl: 'app-assets/car/searchcar.html',
